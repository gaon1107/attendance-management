...
function groupsFor(role: string): NavGroup[] {
  if (role === "admin") {
    return [
      { caption: "회사관리", tintBg: "#E4EDFF", tintText: "#2563EB", items: toItems(["dashboard", "live", "employees", "records", "reports", "leave-approvals", "leave-summary", "notice", "biometrics", "security", "company", "settings"]) },
