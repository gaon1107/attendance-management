...
// 결재함·관리자 휴가승인·관리자 근태정정승인 3곳에서 공용으로 쓴다(레이아웃 무관: 모달이라 표/카드 어디든 안전).
// 서버 액션(rejectLeave/rejectCorrection)을 action prop으로 받아 name="id"·name="comment"를 넘긴다.
    ...
    <>
      ...
      {open && (
        ...
        >
          ...
          >
            <div style={{ fontSize: 16, fontWeight: 700, marginBottom: 6 }}>반려 사유</div>
