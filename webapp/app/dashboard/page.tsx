        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
          ...
          <section style={{ background: "#fff", border: "1px solid var(--border)", borderRadius: 12, overflow: "hidden" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column" }}>
              ...
              {/* 승인 대기 휴가 */}
              <Link href="/leave/approvals" style={{ padding: "12px 18px", borderBottom: (pendingResetCount > 0 || pendingCorrectionCount > 0 || pendingOutingCount > 0 || pendingRemoteCount > 0 || latestNotice) ? "1px solid #F3F4F6" : "none", textDecoration: "none", color: "var(--text)", display: "flex", justifyContent: "space-between", alignItems: "center", gap: 10 }}>
              ...
              {/* 비밀번호 재설정 요청 (있을 때만) */}
              {pendingResetCount > 0 && (
                <Link href="/employees" style={{ padding: "12px 18px", borderBottom: (pendingCorrectionCount > 0 || pendingOutingCount > 0 || pendingRemoteCount > 0 || latestNotice) ? "1px solid #F3F4F6" : "none", textDecoration: "none", color: "var(--text)", display: "flex", justifyContent: "space-between", alignItems: "center", gap: 10 }}>
              ...
              {pendingCorrectionCount > 0 && (
                <Link href="/corrections/approvals" style={{ padding: "12px 18px", borderBottom: (pendingOutingCount > 0 || pendingRemoteCount > 0 || latestNotice) ? "1px solid #F3F4F6" : "none", textDecoration: "none", color: "var(--text)", display: "flex", justifyContent: "space-between", alignItems: "center", gap: 10 }}>
              ...
              {pendingOutingCount > 0 && (
                <Link href="/outing/approvals" style={{ padding: "12px 18px", borderBottom: (pendingRemoteCount > 0 || latestNotice) ? "1px solid #F3F4F6" : "none", textDecoration: "none", color: "var(--text)", display: "flex", justifyContent: "space-between", alignItems: "center", gap: 10 }}>
              ...
              {pendingRemoteCount > 0 && (
                <Link href="/remote/approvals" style={{ padding: "12px 18px", borderBottom: latestNotice ? "1px solid #F3F4F6" : "none", textDecoration: "none", color: "var(--text)", display: "flex", justifyContent: "space-between", alignItems: "center", gap: 10 }}>
