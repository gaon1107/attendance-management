...
//  · 설정 화면의 OfficeMap과 달리 **위치를 바꾸는 상호작용이 없다**: 마커 드래그·지도 클릭으로 좌표를
//    수정할 수 없다(보기 전용). 지도 자체의 이동·확대는 관리자가 주변을 둘러보게 열어 둔다.
//    OfficeMap은 설정 저장에 쓰이는 대화형이라 손대지 않고 별도 컴포넌트로 둔다(공통 모듈 보호).
