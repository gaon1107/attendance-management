# Plan: 접속/보안 3단계 — IP·기기 접속 로그 (2026-07-16) — 상태: **✅ 완료(검수 반영·보관기간 확정)**

> **보관기간 1년 → 2년으로 정정 확정.** code-reviewer가 "접속기록은 지워야 할 개인정보가 아니라
> **보관 의무** 자료"라고 지적 → 사장님이 「개인정보의 안전성 확보조치 기준」**제8조**를 직접 확인:
> 원칙 1년 이상, **고유식별정보·민감정보 처리 시스템은 2년 이상**. 얼굴=민감정보이므로 **730일 확정·적용**.
> 검증: 800일전=파기 / 400일전·오늘=보존.
